...
export const loginSchema = yup.object({
  email: yup.string().email(errorMessages.invalid('Email')).required(errorMessages.required),
...
export const signupSchema = loginSchema.concat(signupFields);
